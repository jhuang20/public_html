...
aba=d['name']
bc=aba.replace("'","")
name=bc.lower()#we will use this variable to store the name of the file we need to retrieve
...
s=revisePage(filename)#store the contents of the file in a variable
...
<div class="navbar">
  ...
  <a class="register" href="../Login/register.html">Register</a>
