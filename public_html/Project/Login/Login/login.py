...
<div class="w3-top">
  <div class="w3-bar" color="1B1B1B" id="myNavbar">
    <a href="../website.html" class="w3-opacity-min w3-bar-item w3-button w3-animate-opacity">HOME</a>
    <a href="../mainpage.html" class="w3-bar-item w3-button w3-hide-small">PLACES</a>	
