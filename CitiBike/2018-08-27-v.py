...
<a href="#about" class="w3-black w3-button "><i class="fa fa-building"></i> OUR MISSION</a>
 ...
 <div id="body" class="w3-content w3-padding-64">
        ...
        <h3 class="w3-center">You are signing up for 2018-08-27 at 13:00 until 16:00</h3>
<p>There are '''+str(2-getnumber())+'''  spots available out of  2</p>
<h3 id="event">Description</h3><p>We need two volunteers to help run the first class. As a volunteer, you will make everything run smoothly! Additionally, you will also get a free day pass! 

Help our program succeed!</p>'''+isFull()+'''<form action="submit.py">
<br>
