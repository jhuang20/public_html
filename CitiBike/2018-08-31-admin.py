...
def getevent():
    ...
    final+="<form action='accept.py'><input type='hidden' id='file' name='file' value='2018-08-27'><input type='hidden' name='osis' value='9999999999'><input type='hidden' name='admit' value='20'><input type='submit' value='un-postpone'></form><br>"
    final+="<form action='close.py'><input type='hidden' id='file' name='file' value='2018-08-27'><input type='submit' value='Close Form'></form><br>"
    final+="<form action='accept.py'><input type='hidden' id='file' name='file' value='2018-08-27'><input type='hidden' name='osis' value='9999999999'><input type='hidden' name='admit' value='10'><input type='submit' value='postpone'></form><br>"
