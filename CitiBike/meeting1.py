...
<div class="w3-top">
 ...
 <div id="body" class="w3-content w3-padding-64">
        <h1 class="w3-center">meeting 1</h1>
        <h3 class="w3-center">You are signing up for 2018-10-03 at 4:00 until 4:30</h3>
<p>There are 25 spots</p>
<h3 id="event">Description</h3><p>We will discuss the future of the program. If you have a leadership position, you must attend this event. We will then ride to Central Park.</p>'''+isFull()+'''<form action="submit.py">
<br>
...
Email: <input name="contact" required="required"></input><br><br>
...
<input type="hidden" id="file" name="file" value='meeting1'>
