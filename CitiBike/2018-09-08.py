...
<a href="#about" class="w3-black w3-button "><i class="fa fa-building"></i> OUR MISSION</a>
 ...
 <div id="body" class="w3-content w3-padding-64">
        ...
        <h3 class="w3-center">Sign up for this date:2018-09-08 at 12:00 until 5:00</h3>
<p>There are '''+str(150-getnumber())+'''  spots available out of  150</p>
...
<input type="hidden" id="file" name="file" value='2018-09-08'>
