...
def getevent(): #retreives event data
    ...
    csvfile = open('RideToSchoolLeaders.csv', "r")#opens the file
    ...
    if 'specialevent'!='safetyclass':
        final+="<p><b>"+str(count-7)+"</b> people are on waitlist</p>" #lists number of people who are signup up and waitlisted
    final+="<p>Remove Person(enter OSIS):<form action='rmperson.py'><input type='text' name='osis'><input type='hidden' id='file' name='file' value='RideToSchoolLeaders'><input type='submit' value='deleteperson'></form></p>"
    if 'specialevent'=='safetyclass' or 'specialevent'=='specialevent':
	final+="<p><b>"+str(countAcceptance)+" people have been accepted</b></p>"
	final+="<p>Accept person(Enter OSIS):<form action='accept.py'><input type='text' name='osis'><input type='hidden' id='file' name='file' value='RideToSchoolLeaders'><input type='hidden' name='admit' value='1'><input type='submit' value='accept'></form></p>"
        final+="<p>Reject Person(Enter OSIS):<form action='accept.py'><input type='text' name='osis'><input type='hidden' id='file' name='file' value='RideToSchoolLeaders'><input type='hidden' name='admit' value='0'><input type='submit' value='reject'></form></p>"
