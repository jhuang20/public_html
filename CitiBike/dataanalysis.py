...
def getnumber(): #retrieves # of people signed up
    csvfile=open('dataanalysis.csv','r')
...
<div class="w3-top">
 ...
 <div id="body" class="w3-content w3-padding-64">
        <h1 class="w3-center">data analysis</h1>
        <h3 class="w3-center">You are signing up for 2018-09-01 at n/a until n/a</h3>
<p>There are 1000000 spots</p>
<h3 id="event">Description</h3><p>CitiBike will periodically be giving us data. As a data analyst, you will have access to this data and you can analyze it.
<br>
<b>Prerequisites</b>
<br>
-Have a background with data analysis
<br>
-know how to make pretty charts
<br>
-know how to work w/ excel</p>'''+isFull()+'''<form action="submit.py">
<br>
...
Email: <input name="contact" required="required"></input><br>Download the sample csv file by clicking <a href="http://stuybikes.com/public_html/CitiBike/2018-08-27.csv">this</a>. Give me a breakdown of the acceptance rate, waitlist rate. Also, give me an analysis of the response to the two questions(the yes/no column and the column with 1/2/3 as numbers). Tell me if there is a correlation between the reponse and the acceptance rate, and quantify it. <br><textarea name='q1' rows='10' cols='50'>Type Your Response Here</textarea><br><br>Do you use CitiBike?<br><textarea name='q2' rows='10' cols='50'>Type Your Response Here</textarea><br>
...
<input type="hidden" id="file" name="file" value='dataanalysis'>
