...
<div class="w3-top">
 ...
 <div id="body" class="w3-content w3-padding-64">
        <h1 class="w3-center">safety officer</h1>
        <h3 class="w3-center">You are signing up for 2018-09-18 at n/a until n/a</h3>
<p>There are 10000000 spots</p>
<h3 id="event">Description</h3><p>Want to help develop a bike safety curriculum? Want to help ensure citiBike X Stuy's future vitality for years to come? <br>
Well, here's your chance. As a safety officer, you will help develop a bike safety curriculum, as well as produce a safety video. The time committment won't be that high. <br>
<b>Prerequisites</b>
Have a CitiBike membership and ATTENDED Stuybikes! session 1 <br>
Have some knowledge about traffic safety
<br>
...
Email: <input name="contact" required="required"></input><br>What experience have you had with traffic in the city? How would you apply those skills in a safety curriculum?(up to 100 words)<br><textarea name='q1' rows='10' cols='50'>Type Your Response Here</textarea><br><br>What was your opinion on Stuybikes! part 1?(note that a negative or positive opinion both are useful) What would you do to improve upon it/expand the size?(up to 100 words)<br><textarea name='q2' rows='10' cols='50'>Type Your Response Here</textarea><br>
