...
def getevent():
    ...
    csvfile = open('2018-08-27-v.csv', "r")#opens the file
	...
	how=show.split(",")
	if count<1:
	    final+="<td><form action='rmperson.py'><input type='hidden' name='file' value='2018-08-27-v'></input><input type='hidden' name='osis' value="+how[0]+"></input><input type='submit' value='deleteperson'></input></td>"
	    final+="<td>No</td>"
            for i in how:
            	final+="<td>"+str(i)+"</td>"
	else:
