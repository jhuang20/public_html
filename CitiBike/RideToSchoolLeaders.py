...
def getnumber(): #retrieves # of people signed up
    csvfile=open('RideToSchoolLeaders.csv','r')
...
<title>Ride To School Leaders</title>
<meta charset="UTF-8">
...
<div class="w3-top">
 ...
 <div id="body" class="w3-content w3-padding-64">
        <h1 class="w3-center">Ride To School Leaders</h1>
        <h3 class="w3-center">You are signing up for 2018-09-03 at 12:00AM until 12:00AM</h3>
<p>There are 7 spots</p>
<h3 id="event">Description</h3><p>Prerequisites:
<br>
-Completed a Stuybikes! session and have a CitiBike membership.
<br>
-Comfortable in traffic
<br>
-Available sometime on September 4th for route planning
<br>
-Filled out the Ride to School form(the non-leaders one)
<br>
<br>
NOTE: this form will open 8/28/18 at 10:23AM
<br>
Help organize and lead our first mass group ride to Stuy! This is meant to showcase the utility of CitiBike.
<br>
Depending on how many people sign up, we will have up to seven routes. 
<br>
As a group ride leader, you will work with us to choose a safe and logical route. </p>'''+isFull()+'''<form action="submit.py">
<br>
...
Email: <input name="contact" required="required"></input><br>Describe your experience riding CitiBike.(<100 words)<br><textarea name='q1' rows='10' cols='50'>Type Your Response Here</textarea><br><br>You're at a red light, and you are leading the group. There is no cross traffic. Describe what you are doing to keep your fellow riders aware of your surroundings. (<100 words)<br><textarea name='q2' rows='10' cols='50'>Type Your Response Here</textarea><br>
...
<input type="hidden" id="file" name="file" value='RideToSchoolLeaders'>
